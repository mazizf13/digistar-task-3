    ...
    <>
      <Layout>
        <div className="flex flex-col md:mx-auto">
          <section className="relative flex items-start w-full h-full md:h-[380px] lg:h-[472px] xl:h-[472px] overflow-hidden bg-gradient-to-r from-[#D6FCFF] to-[#29BBD4]">
            <div className="h-full w-full gap-6 flex flex-col lg:flex-row xl:flex-row items-center justify-center mx-10 my-10 lg:my-0 xl:my-0 lg:mx-40 xl:mx-40">
              <div className="w-full flex flex-col justify-start items-start">
                <div className="mb-4">
                  <h1 className="text-[#002022] font-bold text-xl md:text-[28px] lg:text-[28px] xl:text-[28px] lg:leading-[42px] ">
                    {beranda.title}
                  </h1>
                  <p className="text-[#444B55] text-wrap text-sm md:text-sm lg:text-sm xl:text-sm pb-2 pt-4">
                    {beranda.description}
                  </p>
                </div>
                <div>
